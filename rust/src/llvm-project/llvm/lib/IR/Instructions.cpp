...
UAllocaInst::UAllocaInst(Type *Ty, unsigned AddrSpace, const Twine &Name,
                       Instruction *InsertBefore)
  : UAllocaInst(Ty, AddrSpace, /*ArraySize=*/nullptr, Name, InsertBefore) {}

UAllocaInst::UAllocaInst(Type *Ty, unsigned AddrSpace, const Twine &Name,
                       BasicBlock *InsertAtEnd)
  : UAllocaInst(Ty, AddrSpace, /*ArraySize=*/nullptr, Name, InsertAtEnd) {}

UAllocaInst::UAllocaInst(Type *Ty, unsigned AddrSpace, Value *ArraySize,
                       const Twine &Name, Instruction *InsertBefore)
    : UAllocaInst(Ty, AddrSpace, ArraySize,
...
UAllocaInst::UAllocaInst(Type *Ty, unsigned AddrSpace, Value *ArraySize,
                       ...
                       Instruction *InsertBefore)
    : UnaryInstruction(PointerType::get(Ty, AddrSpace), UAlloca,
...
bool UAllocaInst::isArrayAllocation() const {
...
bool UAllocaInst::isStaticAlloca() const {
...
UAllocaInst *UAllocaInst::cloneImpl() const {
  UAllocaInst *Result =
      new UAllocaInst(getAllocatedType(), getType()->getAddressSpace(),
