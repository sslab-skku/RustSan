...
impl<'tcx> MirPass<'tcx> for MatchBranchSimplification {
    ...
    fn run_pass(&self, tcx: TyCtxt<'tcx>, body: &mut Body<'tcx>) {
        ...
        'outer: for bb_idx in bbs.indices() {
            ...
            from.statements
                .push(Statement { source_info, kind: StatementKind::StorageLive(discr_local), pta_target: false, });
            ...
            from.statements
                .push(Statement { source_info, kind: StatementKind::StorageDead(discr_local), pta_target: false, });
