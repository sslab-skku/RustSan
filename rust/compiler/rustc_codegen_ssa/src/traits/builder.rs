    ...
    + HasTargetSpec
{
    ...
    fn safety(&mut self)->bool {return false}
    fn set_safety(&mut self, safety:bool);
    fn insert_unsafe_metadata(&mut self, _inst: Self::Value);
    fn set_unsafe_args(&mut self, args: u32);
    fn get_unsafe_args(&self) -> u32;
