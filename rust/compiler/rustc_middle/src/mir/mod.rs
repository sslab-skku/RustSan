...
pub struct LocalDecl<'tcx> {
    ...
    // RustSan; checking the local's safety
    pub safety: bool,

    // RustSan; checking if local's allocated
...
impl<'tcx> BasicBlockData<'tcx> {
        ...
        I: iter::TrustedLen<Item = Statement<'tcx>>,
    {
        ...
        self.statements.resize(
            gap.end,
            Statement { source_info: SourceInfo::outermost(DUMMY_SP), kind: StatementKind::Nop, pta_target: false, },
        );
