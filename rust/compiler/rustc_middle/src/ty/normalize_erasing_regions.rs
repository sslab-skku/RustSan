...
impl<'tcx> NormalizeAfterErasingRegionsFolder<'tcx> {
    fn normalize_generic_arg_after_erasing_regions(
        ...
        let arg2 = self.param_env.and(arg);

        // kimjy: screw it, just ignore bug here
        /*
        ...
        */
        self.tcx.try_normalize_generic_arg_after_erasing_regions(arg2).unwrap_or_else(|_| { return arg; })
    }
}
