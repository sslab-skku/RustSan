...
//    callsites: &'tcx std::collections::HashMap<rustc_span::def_id::DefId, Vec<usize>>,
}
...
pub struct GlobalCtxt<'tcx> {
    ...
    pub callsites: rustc_data_structures::fx::FxHashMap<rustc_span::def_id::DefId, Vec<usize>>,

    pub callsites_by_callee: rustc_data_structures::fx::FxHashMap<rustc_span::def_id::DefId, Vec<(rustc_span::def_id::DefId, usize)>>,

    pub unsafe_locals_by_func: rustc_data_structures::fx::FxHashMap<rustc_span::def_id::DefId, Vec<bool>>,

    pub bodies: Vec<rustc_span::def_id::DefId>,
}
...
impl<'tcx> TyCtxt<'tcx> {
    ...
    pub fn create_global_ctxt(
        ...
        GlobalCtxt {
            ...
            callsites: rustc_data_structures::fx::FxHashMap::default(),
            callsites_by_callee: rustc_data_structures::fx::FxHashMap::default(),
            unsafe_locals_by_func: rustc_data_structures::fx::FxHashMap::default(),
            bodies: Vec::new(),
        }
    }
...
pub mod tls {
    ...
    impl<'a, 'tcx> ImplicitCtxt<'a, 'tcx> {
        pub fn new(gcx: &'tcx GlobalCtxt<'tcx>) -> Self {
            // let tcx = TyCtxt { gcx, callsites: &std::collections::HashMap::new(), };
            let tcx = TyCtxt { gcx, };
            ImplicitCtxt {
                tcx,
                query: None,
