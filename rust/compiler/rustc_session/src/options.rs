...
top_level_options!(
    ...
    pub struct Options {
        ...
        /// unsafe Rust to LLVM IR
        unsafe_to_ir : bool [TRACKED],

        /// unsafe alloca marking through MIR analysis
        unsafe_mir: bool [TRACKED],

        mark_alloc: bool [TRACKED],
        
        pta_filter: bool [TRACKED],

        /// RustSan debug purpose
        mydbg: bool [TRACKED],
