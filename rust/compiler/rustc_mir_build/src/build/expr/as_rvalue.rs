...
impl<'a, 'tcx> Builder<'a, 'tcx> {
    ...
    pub(crate) fn as_rvalue(
        ...
        match expr.kind {
            ...
            ExprKind::Box { value } => {
                ...
                this.cfg.push(
                    block,
                    Statement { source_info, kind: StatementKind::StorageLive(result), pta_target: false },
                );
    ...
    fn limit_capture_mutability(
        ...
        this.cfg.push(block, Statement { source_info, kind: StatementKind::StorageLive(temp), pta_target: false });
